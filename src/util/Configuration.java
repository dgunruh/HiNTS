...
public class Configuration {
	...
	// System
	public static final int STEPS = 500000; //total number of steps
	public static final int MIN_THRESH_STEPS = 250000; //number of steps before values are recorded
	...
	public static final double ligandLength = 0.5 ; // in nm, was 0.2 for Moule project //was 0.45 for tridens // was .1 for the necking
	...
	public static final String effectiveMedium = "mg"; //"mg" or "shklovskii global" or "shklovskii local" or "shklovskii sphere"
	public static final String poissonSolver = "none"; //"none" or "nn" or "nnn"
	...
	public static final boolean necking = true;
